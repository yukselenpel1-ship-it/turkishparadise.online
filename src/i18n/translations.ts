...
export const CHANCE_CARDS_TRANSLATIONS: Record<Language, Record<string, { title: string; description: string }>> = {
  tr: {
    ...
    c10: { title: 'İskele Seyahati', description: 'En yakın iskeleye hızlı seyahat edin. Başlangıç noktasından geçerseniz 200₺ kazanın.' },
  ...
  en: {
    ...
    c10: { title: 'Ferry Trip', description: 'Advance to the nearest ferry station. If you pass GO, collect $200.' },
